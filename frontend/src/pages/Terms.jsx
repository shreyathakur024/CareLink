...
const Terms = () => {
  return (
    <div className="legal-container">
      <h1 className="legal-title">Terms of Service for CareLink</h1>
      <p className="legal-last-updated"><strong className="legal-strong">Last Updated:</strong> March 3, 2026</p>

      <p className="legal-paragraph">Welcome to CareLink. These Terms of Service ("Terms") govern your access to and use of the CareLink website and appointment scheduling services. By using our platform, you agree to comply with and be bound by these Terms.</p>

      <h2 className="legal-heading">1. Description of Service</h2>
      <p className="legal-paragraph">CareLink is an online platform that facilitates the scheduling of medical appointments between patients and independent healthcare providers (doctors, clinics, etc.). <strong className="legal-strong">CareLink is not a healthcare provider</strong> and does not provide medical advice, diagnosis, or treatment.</p>
      ...
      <p className="legal-paragraph">By creating an account and using CareLink, you agree to:</p>
      ...
      <p className="legal-paragraph">When you book an appointment through CareLink, you are committing to a scheduled time with a healthcare provider. We ask that you respect their time:</p>
      <ul className="legal-list">
        ...
        <li><strong className="legal-strong">No-Shows:</strong> Repeated failure to attend scheduled appointments ("no-shows") may result in the suspension or termination of your CareLink account.</li>
      </ul>

      <h2 className="legal-heading">5. Relationship with Healthcare Providers</h2>
      <p className="legal-paragraph">The doctors and clinics listed on CareLink are independent professionals. We do not guarantee the availability, quality, or outcome of any medical services you receive. Any disputes regarding medical care, billing for medical services, or patient-doctor relationships are strictly between you and the healthcare provider.</p>

      <h2 className="legal-heading">6. Intellectual Property</h2>
      <p className="legal-paragraph">All content, features, and functionality on the CareLink website—including text, graphics, logos, and software—are the exclusive property of CareLink or its licensors and are protected by copyright, trademark, and other intellectual property laws.</p>

      <h2 className="legal-heading">7. Limitation of Liability</h2>
      <p className="legal-paragraph">To the fullest extent permitted by law, CareLink shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including any medical complications, loss of profits, data, or goodwill, arising out of your use of or inability to use our platform.</p>
      ...
      <address className="legal-address">
        <strong className="legal-strong">Email:</strong> legal@CareLink.com<br /><br />
