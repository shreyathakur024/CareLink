...
const Cookie = () => {
  return (
    <div className="legal-container">
      <h1 className="legal-title">Cookie Policy for CareLink</h1>
      <p className="legal-last-updated"><strong className="legal-strong">Last Updated:</strong> March 3, 2026</p>

      <p className="legal-paragraph">This Cookie Policy explains how CareLink uses cookies and similar technologies to recognize you when you visit our website. It explains what these technologies are and why we use them, as well as your rights to control our use of them.</p>
      ...
      <p className="legal-paragraph">We use first-party and third-party cookies for several reasons. Some cookies are required for technical reasons in order for our CareLink platform to operate securely, especially when handling user accounts and appointment bookings. We refer to these as "essential" or "strictly necessary" cookies. Other cookies enable us to track and target the interests of our users to enhance the experience on our online properties.</p>

      <h2 className="legal-heading">3. Types of Cookies We Use</h2>
      <ul className="legal-list">
        <li>
          <strong className="legal-strong">Essential Cookies:</strong> These cookies are strictly necessary to provide you with services available through our website. They include, for example, cookies that enable you to log into secure areas of CareLink and book medical appointments safely.
        </li>
        <li>
      ...
      <p className="legal-paragraph">Because CareLink deals with sensitive health-related appointments, <strong className="legal-strong">we do not use advertising cookies to track your medical inquiries across the internet</strong>. The data collected via cookies is strictly used to facilitate your appointments, keep your session secure, and improve our website's technical performance.</p>
      ...
      <p className="legal-paragraph">If you have any questions about our use of cookies or other technologies, please email us at <strong className="legal-strong">privacy@CareLink.com</strong>.</p>
    </div>
  );
};
